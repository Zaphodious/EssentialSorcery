...
public class GloveLeather extends BasicBoard {

	public GloveLeather(String unlocalizedName, Element element) {
		super(unlocalizedName, MaterialLevel.LEATHER, element);
