...
public class ModelHobgoblin extends ModelBiped {
	...
	public ModelHobgoblin() {
		...
		//this.head.setTextureOffset(0,0).addBox(-3.5F, -5F, 1F, 3, 4, 4); // right lobe
		//this.head.setTextureOffset(40, 0).addBox(0.5F, -5F, 1F, 3, 4, 4); // left lobe
	...
	@Override
	public void render(Entity entityIn, float time, float limbSwingDistance,
			float unknownValue, float headYRot, float headXRot, float scale) {
	 ...
	 */
	@Override
	public void setRotationAngles(float time, float limbSwingDistance,
			float p_78087_3_, float headYRot, float headXRot,
