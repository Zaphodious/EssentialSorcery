...
public class OreSpawnJSON {
	...
	public static final void makeOreGenConfigFile(FMLPreInitializationEvent event) {
		Path oreSpawnFolder =
				Paths.get(event.getSuggestedConfigurationFile().toPath().getParent().toString(), "orespawn");
