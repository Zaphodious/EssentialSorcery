...
public final class ModItems {
	 ...
	 * public static Item jadeOrePlacer; public static Item jadeBlockRedPlacer;
	 * public static Item jadeBlockWhitePlacer; public static Item
	 * jadeBlockBluePlacer; public static Item jadeBlockGreenPlacer; public
	 * static Item jadeBlockBlackPlacer;
	 */
	...
	public static ArrayList<Item> getBoardRegistery() {
		...
		/*
		 * Adding these items to a list helps sort through them quickly, meaning
		 * that I don't need to hard-code in every single one of them into the
		 * custom crafting stuff.
		 */
