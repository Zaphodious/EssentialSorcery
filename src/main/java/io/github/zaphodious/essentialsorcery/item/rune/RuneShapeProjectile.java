...
public class RuneShapeProjectile extends RuneShape {
	...
	public boolean deployTargetingEntity(Map<String, ItemStack> runeMapIn, World worldIn, EntityPlayer playerIn) {
		...
		if (!worldIn.isRemote) {
			...
			case AIR:
				targetingProjectile = (TargetingProjectile) new TargetingProjectileAir(worldIn, playerIn);
				break;
			case EARTH:
				targetingProjectile = (TargetingProjectile) new TargetingProjectileEarth(worldIn, playerIn);
				break;
			case FIRE:
				targetingProjectile = (TargetingProjectile) new TargetingProjectileFire(worldIn, playerIn);
				break;
			case NEUTRAL:
				targetingProjectile = (TargetingProjectile) new TargetingProjectileFire(worldIn, playerIn);
				break;
			case WATER:
				targetingProjectile = (TargetingProjectile) new TargetingProjectileWater(worldIn, playerIn);
				break;
			case WOOD:
				targetingProjectile = (TargetingProjectile) new TargetingProjectileWood(worldIn, playerIn);
				break;
			default:
				targetingProjectile = (TargetingProjectile) new TargetingProjectileFire(worldIn, playerIn);
				break;
