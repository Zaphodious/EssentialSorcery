...
public class GenTest {
	...
	public static boolean makeAWall(
		...
		for (int j = 0; j < 10; j++) {
			...
			for (int i = 0; i < 5; i++) {
				...
				IBlockState toPlace =
						(j > 5 || j < 3) ? ModBlocks.moon_silver_block
								.getDefaultState() : Blocks.coal_block
								.getDefaultState();
	...
	public static boolean genTestStructure(
		...
		world.setBlockState(
				...
				3);
		world.setBlockState(
				new BlockPos(x + 2, y + 0, z + 0),
				Blocks.cobblestone.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 3, y + 0, z + 0),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 4, y + 0, z + 0),
		...
		world.setBlockState(
				...
				3);
		world.setBlockState(
				new BlockPos(x + 1, y + 0, z + 1),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 2, y + 0, z + 1),
				Blocks.cobblestone.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 3, y + 0, z + 1),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 4, y + 0, z + 1),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 0, y + 0, z + 2),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 1, y + 0, z + 2),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 2, y + 0, z + 2),
				Blocks.cobblestone.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 3, y + 0, z + 2),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 4, y + 0, z + 2),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 0, y + 0, z + 3),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 1, y + 0, z + 3),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 2, y + 0, z + 3),
				Blocks.cobblestone.getDefaultState(),
				3);
		world.setBlockState(
				...
				3);
		world.setBlockState(
				new BlockPos(x + 4, y + 0, z + 3),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 0, y + 0, z + 4),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 1, y + 0, z + 4),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 2, y + 0, z + 4),
				Blocks.cobblestone.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 3, y + 0, z + 4),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 4, y + 0, z + 4),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 0, y + 0, z + 5),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 1, y + 0, z + 5),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 2, y + 0, z + 5),
				Blocks.cobblestone.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 3, y + 0, z + 5),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 4, y + 0, z + 5),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 0, y + 0, z + 6),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 1, y + 0, z + 6),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 2, y + 0, z + 6),
				Blocks.cobblestone.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 3, y + 0, z + 6),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 4, y + 0, z + 6),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 0, y + 0, z + 7),
				Blocks.lapis_block.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 1, y + 0, z + 7),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 2, y + 0, z + 7),
				Blocks.cobblestone.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 3, y + 0, z + 7),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 4, y + 0, z + 7),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
		...
		world.setBlockState(
				...
				3);
		world.setBlockState(
				new BlockPos(x + 2, y + 1, z + 0),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 3, y + 1, z + 0),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 4, y + 1, z + 0),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
		...
		world.setBlockState(
				...
				3);
		world.setBlockState(
				new BlockPos(x + 4, y + 1, z + 1),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 0, y + 1, z + 2),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 1, y + 1, z + 2),
				Blocks.cobblestone.getDefaultState(),
				3);
		world.setBlockState(
		...
		world.setBlockState(
				...
				3);
		world.setBlockState(
				new BlockPos(x + 4, y + 1, z + 3),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 0, y + 1, z + 4),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 1, y + 1, z + 4),
				Blocks.cobblestone.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 2, y + 1, z + 4),
				Blocks.cobblestone.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 3, y + 1, z + 4),
				Blocks.bedrock.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 4, y + 1, z + 4),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 0, y + 1, z + 5),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 1, y + 1, z + 5),
				Blocks.cobblestone.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 2, y + 1, z + 5),
				Blocks.cobblestone.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 3, y + 1, z + 5),
				Blocks.bedrock.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 4, y + 1, z + 5),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 0, y + 1, z + 6),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 1, y + 1, z + 6),
				Blocks.cobblestone.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 2, y + 1, z + 6),
				Blocks.cobblestone.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 3, y + 1, z + 6),
				Blocks.bedrock.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 4, y + 1, z + 6),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 0, y + 1, z + 7),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 1, y + 1, z + 7),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 2, y + 1, z + 7),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 3, y + 1, z + 7),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 4, y + 1, z + 7),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 0, y + 2, z + 0),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 1, y + 2, z + 0),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 2, y + 2, z + 0),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 3, y + 2, z + 0),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 4, y + 2, z + 0),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 0, y + 2, z + 1),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
		...
		world.setBlockState(
				...
				3);
		world.setBlockState(
				new BlockPos(x + 0, y + 2, z + 4),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 1, y + 2, z + 4),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 2, y + 2, z + 4),
				Blocks.bedrock.getDefaultState(),
				3);
		world.setBlockState(
		...
		world.setBlockState(
				...
				3);
		world.setBlockState(
				new BlockPos(x + 0, y + 2, z + 7),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 1, y + 2, z + 7),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 2, y + 2, z + 7),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 3, y + 2, z + 7),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 4, y + 2, z + 7),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 0, y + 3, z + 0),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 1, y + 3, z + 0),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
				...
				3);
		world.setBlockState(
				new BlockPos(x + 3, y + 3, z + 0),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 4, y + 3, z + 0),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 0, y + 3, z + 1),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
		...
		world.setBlockState(
				...
				3);
		world.setBlockState(
				new BlockPos(x + 0, y + 3, z + 2),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 1, y + 3, z + 2),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
		...
		world.setBlockState(
				...
				3);
		world.setBlockState(
				new BlockPos(x + 0, y + 3, z + 7),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 1, y + 3, z + 7),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
		...
		world.setBlockState(
				...
				3);
		world.setBlockState(
				new BlockPos(x + 0, y + 4, z + 0),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 1, y + 4, z + 0),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 2, y + 4, z + 0),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 3, y + 4, z + 0),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
				...
				3);
		world.setBlockState(
				new BlockPos(x + 0, y + 4, z + 1),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 1, y + 4, z + 1),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
		...
		world.setBlockState(
				...
				3);
		world.setBlockState(
				new BlockPos(x + 0, y + 4, z + 2),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
				new BlockPos(x + 1, y + 4, z + 2),
				Blocks.air.getDefaultState(),
				3);
		world.setBlockState(
